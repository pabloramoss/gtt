...
export default function Home() {
  ...
  const handleShowQRScreen = () => {
    setShowQRScreen(!showQRScreen)
  }

  return (
    <main className="bg-white h-[100dvh]">
      <Biglietto onTicketClick={handleShowTicketScreen} onQRClick={handleShowQRScreen} onPdfClick={handlePdfClick} />
      {showTicketScreen && <Daily onTicketClick={handleShowTicketScreen} />}
      {showQRScreen && <QRScreen onTicketClick={handleShowQRScreen} />}
      {isLoading && (
